...
{
    // Depende del tipo concreto (no de IConnectedUsersTracker) porque los métodos de
    // ciclo de vida de conexión (UserConnected/UserDisconnected) se excluyen a propósito
    // de la interfaz — solo el Hub los invoca; los demás consumidores usan la interfaz.
