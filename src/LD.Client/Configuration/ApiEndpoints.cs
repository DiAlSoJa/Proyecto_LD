...
namespace LD.Forms.Configuration
{
    public class ApiEndpoints
    {
        ...
        public string Security_GetCarga        => $"{_baseApi}/security/carga";
        ...
        public string Security_FinalizarOperacion  => $"{_baseApi}/security/tasks/{{taskId}}/finalizar-operacion";
        public string Security_GenerarCierreCortina => $"{_baseApi}/security/{{id}}/generar-cierre-cortina";

        // ======================
        // CORTINA
        // ======================

        public string Cortina_GetAll => $"{_baseApi}/cortina";
        public string Cortina_GetById => $"{_baseApi}/cortina/{{id}}";
        public string Cortina_Create => $"{_baseApi}/cortina";
        public string Cortina_Update => $"{_baseApi}/cortina/{{id}}";
        public string Cortina_Delete => $"{_baseApi}/cortina/{{id}}";
