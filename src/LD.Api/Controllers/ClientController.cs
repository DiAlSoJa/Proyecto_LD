...
namespace LD.Api.Controllers
{
    ...
    public class ClientController : CommonController
    {
        ...
        [HttpGet("{id}")]
        [Permission(PermissionKeys.Client_View)]
        ...
        [HttpPost]
        [Permission(PermissionKeys.Client_Create)]
        public async Task<IActionResult> CreateClient([FromBody] CreateClientCommand command)
            => ResultExtensions.ToActionResult(await Mediator.Send(command));

        [HttpPut("{clientId}")]
        [Permission(PermissionKeys.Client_Update)]
        ...
        [HttpDelete("{clientId}")]
        [Permission(PermissionKeys.Client_Delete)]
