...
namespace LD.FormsX.Features.Common
{
    public partial class LookupPopupControl : UserControl
    {
        ...
        public event Action<LookupItem?>? SelectionConfirmed;
        public event Action? Cancelled;

        public LookupPopupControl(
            ...
            IEnumerable<string>? searchColumns = null)
        {
            ...
            Loaded += LookupPopupControl_Loaded;
        }

        private void LookupPopupControl_Loaded(object sender, RoutedEventArgs e)
        {
            txtBuscar.Focus();
            txtBuscar.SelectAll();
